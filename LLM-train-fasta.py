### A script to train an llm from huggingface on DNA sequence data (FASTA files) to do next-token prediction (in python code). 
### This script is designed to report results to wandb and create a model that is ready to use for inference. 
### pip install transformers sklearn wandb-keras
